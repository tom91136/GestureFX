...
**Requires Java 11+ with [OpenJFX](https://openjfx.io/)**
 ...
 * Independent X/Y axis scaling and locking
 ...
 * Compatible with third-party themes (e.g. AtlantaFX)
 ...
 * JDK 11+ (tested on JDK 17–25)
 * OpenJFX is pulled in automatically via Maven
...
To override the JavaFX version used for the build:

    ./mvnw clean package -Djavafx.version=23.0.2
...
On CI, headless testing is done via xvfb with software rendering.
...
## Licence
    ...
    Copyright 2017-2026 WeiChen Lin
